...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'char@2xht.ml',
  ...
  title: "CharTyr's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/Charfile',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/CharTyr',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/chartyr',
    },
  ],
